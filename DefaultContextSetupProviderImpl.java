...
/**
 * The default context setup provider.  delegates context saving/setting/resetting to the context handle factory
 * provided by the current concurrent context.
 *
...
public class DefaultContextSetupProviderImpl implements ContextSetupProvider {
    ...
    @Override
    public org.glassfish.enterprise.concurrent.spi.ContextHandle saveContext(
    ...
    @Override
    public org.glassfish.enterprise.concurrent.spi.ContextHandle setup(
            org.glassfish.enterprise.concurrent.spi.ContextHandle contextHandle) throws IllegalStateException {
