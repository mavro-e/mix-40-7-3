...
/**
 * A wrapper for a {@link org.glassfish.enterprise.concurrent.spi.TransactionSetupProvider} stored in a service,
 * allowing deserialization through MSC.
 * @author emmartins
 */
public class ServiceTransactionSetupProvider implements TransactionSetupProvider {
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        // resolve from msc
        final ServiceContainer currentServiceContainer
                = System.getSecurityManager() == null
                          ? CurrentServiceContainer.getServiceContainer()
                          : AccessController.doPrivileged(CurrentServiceContainer.GET_ACTION);
